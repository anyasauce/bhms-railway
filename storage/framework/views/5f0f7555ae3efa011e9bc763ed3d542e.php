...
<?php $__env->startSection('content'); ?>
    ...
    <section class="contact-section py-3 py-md-5 py-xl-8">
        <div class="container">
            <h2 class="section-title text-center mb-5 fw-bold mt-5" data-aos="fade-up">Contact</h2>
        </div>

        <div class="container">
            <div class="row gy-4 gy-md-5 gy-lg-0 align-items-md-center">
                <div class="col-12 col-lg-6">
                    <div class="border overflow-hidden" data-aos="fade-right">
                ...
                <div class="col-12 col-lg-6">
                    <div class="row justify-content-xl-center">
                        <div class="col-12 col-xl-11">
                            <div class="mb-4 mb-md-5" data-aos="fade-left">
                            ...
                            <div class="row mb-sm-4 mb-md-5">
                                <div class="col-12 col-sm-6">
                                    <div class="mb-4 mb-sm-0" data-aos="fade-up">
                                        <div class="mb-3 text-primary">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="mb-4 mb-sm-0" data-aos="fade-up" data-aos-delay="100">
                                        <div class="mb-3 text-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boardinghouse\resources\views\main\contact.blade.php ENDPATH**/ ?>