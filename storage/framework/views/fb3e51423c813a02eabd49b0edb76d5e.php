    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <ul class="d-flex align-items-center">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                <img class="img-xs rounded-circle" src="<?php echo e(asset('assets/images/user.png')); ?>"
                    style="width: 40px; height: 40px; object-fit: cover;" alt="Profile image">
                <span class="d-none d-md-block dropdown-toggle ps-2"> <?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></span>
...
<?php /**PATH C:\xampp\htdocs\boardinghouse\resources\views/layouts/boarderportal.blade.php ENDPATH**/ ?>